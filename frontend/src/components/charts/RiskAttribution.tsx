    ...
    <div className="glass rounded-xl p-5">
      ...
      <ResponsiveContainer width="100%" height={200} className="mt-4">
        <BarChart data={chartData} layout="vertical">
          ...
          <Tooltip contentStyle={{ background: '#161B22', border: '1px solid rgba(56,189,148,0.2)', borderRadius: 8, fontFamily: 'JetBrains Mono', fontSize: 11 }} formatter={(v: number | string) => [`${v}%`, 'Risk Share']} />
